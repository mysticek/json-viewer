...
const PreObjectType = (props)=>{
    ...
    const isArray = useMemo(()=>Array.isArray(props.value), [
        props.value
    ]);
...
const DataKeyPair = (props)=>{
    ...
    return /*#__PURE__*/ jsxs(Box, {
        ...
        children: [
            ...
            }) : Component ? /*#__PURE__*/ jsxs(Fragment, {
                children: [
...
export { JsonViewer, applyValue, bigIntType, booleanType, createDataType, darkColorspace, dateType, defineDataType, defineEasyType, deleteValue, floatType, functionType, intType, isCycleReference, lightColorspace, nanType, nullType, objectType, safeStringify, stringType, undefinedType };
